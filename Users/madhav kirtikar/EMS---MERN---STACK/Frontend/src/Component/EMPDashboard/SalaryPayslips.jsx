  ...
  return (
    <div className="max-w-3xl mx-auto mt-10">
      ...
      <div className="flex flex-wrap gap-4 justify-center mb-8">
        <div className="bg-green-50 border border-green-200 rounded-xl px-6 py-3 flex flex-col items-center shadow">
          <span className="text-xs text-green-700 font-semibold">Total Credited</span>
          <span className="text-xl font-bold text-green-700">₹{totalCredited}</span>
        </div>
        <div className="bg-red-50 border border-red-200 rounded-xl px-6 py-3 flex flex-col items-center shadow">
          <span className="text-xs text-red-700 font-semibold">Total Deductions</span>
          <span className="text-xl font-bold text-red-700">₹{totalDeductions}</span>
        </div>
        <div className="bg-blue-50 border border-blue-200 rounded-xl px-6 py-3 flex flex-col items-center shadow">
          <span className="text-xs text-blue-700 font-semibold">Payslips</span>
          <span className="text-xl font-bold text-blue-700">{filteredData.length}</span>
        </div>
        <div className="bg-purple-50 border border-purple-200 rounded-xl px-6 py-3 flex flex-col items-center shadow">
          <span className="text-xs text-purple-700 font-semibold">Highest Net</span>
          <span className="text-xl font-bold text-purple-700">₹{highestNet}</span>
        </div>
        <div className="bg-pink-50 border border-pink-200 rounded-xl px-6 py-3 flex flex-col items-center shadow">
          <span className="text-xs text-pink-700 font-semibold">Lowest Net</span>
          <span className="text-xl font-bold text-pink-700">₹{lowestNet}</span>
        </div>
      </div>
      ...
      <div className="flex flex-wrap gap-2 mb-6 items-center justify-between">
        <input
          ...
          className="px-4 py-2 rounded-full border border-purple-200 text-sm focus:outline-none focus:ring-2 focus:ring-purple-200"
          value={search}
          ...
          <table className="min-w-full rounded-xl">
            <thead>
              <tr>
                ...
                <th className="py-4 px-6 text-center text-xs font-bold text-purple-700 uppercase bg-purple-50 rounded-tr-2xl">
                  Download
                </th>
              </tr>
            </thead>
              ...
              <div className="relative z-10">
                ...
                <div className="mb-2">
                  ...
                  <span className="text-gray-800">
                    {new Date(selectedPayslip.date).toLocaleDateString("en-IN", {
                      day: "2-digit",
                      month: "short",
                      year: "numeric",
                    })}
                ...
                <div className="flex justify-between mb-2">
                  ...
                  <span className={`font-bold ${selectedPayslip.status === "Credited" ? "text-green-700" : "text-yellow-700"}`}>
